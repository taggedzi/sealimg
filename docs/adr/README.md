...
Architecture Decision Records (ADRs) capture decisions that should remain stable over time.
...
## Records
- [0001 - Adopt Python for CLI/Core Implementation](./0001-adopt-python.md) (`Accepted`)
- [0002 - Crypto Strategy: Native Libraries + Optional GPG Interop](./0002-crypto-native-plus-gpg.md) (`Accepted`)
